...
<title>AfriMed Clinical Services Application</title>
...
<script>
    $(document).ready(function () {
		...
		$("#paymentQueue").click(function(){
			
			mainTab.tabs('add','paymentQueue.php','Bill Payment Queue');
			var newIndex = mainTab.tabs("length") - 1;
			mainTab.tabs("select", newIndex);
		});
		...
		$("#editPatient").click(function(){
			...
			mainTab.tabs('add','editPatient.php','Edit Patient Record');
			var newIndex = mainTab.tabs("length") - 1;
			mainTab.tabs("select", newIndex);
		});
...
<div id="contentTab">
  ...
  <div id="a"><b>Welcome to AfriMed Clinical Services Database Application</b></br></div>
...
<div id="myAccordion">
  ...
  <div class="ui-state-default  ">
    ...
    <div class="ui-state-default ">
    <a href="#" id="paymentQueue">Payment Queue</a></div>
    <div class="ui-state-default ">
    ...
    <div class="ui-state-default ">
    <a href="#" id="editPatient">Edit Record</a></div>
	</div>
